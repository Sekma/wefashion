...
<div class="container shadow-sm bg-body p-4">
  ...
  <ul class="list-group my-4">
    ...
    <li class="list-group-item d-flex justify-content-around"><span class="fw-bold pt-1">Liste des Catégories : </span><a class="btn btn-outline-primary shadow" href="{{route('category.index')}}">Catégories</a></li>
  </ul>
